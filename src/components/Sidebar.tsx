...
export default function TopNav() {
  ...
  return (
    <header className="sticky top-0 z-20 bg-slate-50 border-b border-slate-200">
...
export function BottomNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-20 bg-slate-50 border-t border-slate-200 flex items-center">
