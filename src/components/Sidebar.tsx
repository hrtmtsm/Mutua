...
export default function TopNav() {
  ...
  return (
    <header className="sticky top-0 z-20 bg-white border-b border-stone-200/60 shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
...
export function BottomNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-20 bg-white border-t border-stone-200/60 shadow-[0_-1px_3px_rgba(0,0,0,0.04)] flex items-center">
