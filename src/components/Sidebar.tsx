...
export default function TopNav() {
  ...
  return (
    <header className="sticky top-0 z-20 bg-[#F4F4F4] border-b border-stone-200/40">
...
export function BottomNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-20 bg-[#F4F4F4] border-t border-stone-200/40 flex items-center">
