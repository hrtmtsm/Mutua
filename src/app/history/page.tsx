...
function StatCard({ value, label }: { value: string; label: string }) {
  return (
    <div className="flex-1 flex flex-col items-center justify-center py-4 px-2 bg-white rounded-2xl shadow-sm">
  ...
  return (
    <AppShell>
      <main className="flex-1 px-6 py-10 max-w-2xl mx-auto w-full space-y-6">
        ...
        {/* ── Weekly goal ── */}
        {stats && (
          <div className="px-5 py-4 space-y-3 bg-white rounded-2xl shadow-sm">
            ...
            <div className="space-y-3">
              {partners.map(p => (
                <div
                  ...
                  className="px-5 py-4 space-y-3 bg-white rounded-2xl shadow-sm"
                >
